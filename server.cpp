...
server::server(short port, int thread_cnt)
	...
	//, acceptor_(io_service_pool_.get_io_service(), tcp::endpoint(boost::asio::ip::address_v4::from_string("219.224.168.68"), port))
	, acceptor_(io_service_pool_.get_io_service(), tcp::endpoint(boost::asio::ip::address_v4::from_string("219.224.168.69"), port))
{
