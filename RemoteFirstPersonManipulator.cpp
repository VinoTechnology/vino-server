...
const float RemoteFirstPersonManipulator::step=0.12;//0.2
const float RemoteFirstPersonManipulator::step_rotation=(osg::PI/1500);//5度 2800
...
bool RemoteFirstPersonManipulator::isViewpointChanged()
{
	...
	if(v_distance >=6 || v_rotation>0.01)
		return true;
